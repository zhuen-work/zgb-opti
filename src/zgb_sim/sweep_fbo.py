"""Parallel parameter sweep engine for FBO_S1/S2 (Numba). Mirrors sweep_orb.py.

FBOS1Config has different signal_tf_minutes (30 for S1, 15 for S2).
"""
...
def _progress(done, total, t0):
    ...
    print(f"    [{done}/{total}] {rate:.2f} cfg/s  elapsed={elapsed:.0f}s  eta={eta_s:.0f}s",
          flush=True, file=sys.__stdout__)
