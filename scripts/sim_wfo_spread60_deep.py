...
OUT_DIR = ROOT / "output" / "sim_wfo_spread60_deep_apr25"
SET_OUT = ROOT / "configs" / "sets" / "scalp_v1_sim_spread60_deep_apr25.set"


def build_config_grid(tiny: bool = False, hedge: bool = False) -> list[S1Config]:
    """Wide sweep at 60-pt spread, HTP disabled.
    Stress-tests very wide TP (up to 2000), wide SL (up to 500), and aggressive Tgt (up to 50%).
    """
    if tiny:
        donch_vals = (30, 50)
        tp_vals = (500,)
        ...
        donch_vals = (30, 40, 50, 60)
        tp_vals = (300, 500, 700, 1000, 1500, 2000)
        sl_vals = (70, 100, 150, 200, 300, 500)
        htp_vals = (0.0,)                          # HalfTP disabled
        tgt_vals = (6.0, 9.0, 12.0, 18.0, 25.0, 35.0, 50.0)
