...
SL_MULTS = [1.0, 1.1, 1.2, 1.3, 1.4, 1.5]                        # 6 — unchanged
PROFIT_MULTS = [2.0, 2.5, 3.0, 3.5, 4.0]                         # 5 — 2026-05-21 sweep: 0.5 step over 2.0-4.0 (brackets R2 winners 2.5-3.5)
PARTIAL_FRACTIONS = [0.5, 0.6, 0.7, 0.8]                         # 4 — 2026-05-21 sweep: 0.1 step over 0.5-0.8 (test higher alpha = bigger Stage 1)
...
def simulate_reverse_hedges(sl_events, ticks_arr, stream_cfg: dict,
    ...
    for ev in sl_events:
        ...
        # Pending lifecycle: LIMIT trigger window
