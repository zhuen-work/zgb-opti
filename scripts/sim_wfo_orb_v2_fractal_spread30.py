"""WFO for ORB with V2 fractal-confirm — SPREAD=30pt variant (2× standard 60pt).
...
RISK_PCT = 6.0
DEPOSIT = 10_000.0
N_WORKERS = 6  # bars cache pre-warmed → workers don't need MT5
SIGNAL_TF = "M5"
WFO_SPREAD_PTS = 30  # live-match (live spread is 21-22pt; 30pt is the conservative live-match value)
OUT_DIR = ROOT / "output" / "wfo_orb_v2_may23_spread30"
