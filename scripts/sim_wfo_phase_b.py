...
OUT_DIR = ROOT / "output" / "sim_wfo_phase_b_apr25"
SET_OUT = ROOT / "configs" / "sets" / "scalp_v1_sim_phase_b_apr25.set"


def build_config_grid(tiny: bool = False, hedge: bool = False) -> list[S1Config]:
    """Phase B: narrow grid around Phase A winner
    Phase A winner: Donch=35 TP=300 SL=40 HTP=0.6 Tgt=12 Loss=8 PEB=2."""
    if tiny:
        donch_vals = (35, 40)
        tp_vals = (300,)
        sl_vals = (40,)
        ...
        donch_vals = (30, 35, 40, 45, 50)      # extend wider beyond 35
        tp_vals = (250, 300, 350, 400)         # around 300
        sl_vals = (35, 40, 45)                  # around 40
        htp_vals = (0.5, 0.6, 0.7)              # refine around 0.6
        tgt_vals = (9.0, 12.0, 15.0)            # around 12
        loss_vals = (6.0, 8.0, 10.0)            # around 8
        peb_vals = (2,)                         # fix at winner
    grid = []
