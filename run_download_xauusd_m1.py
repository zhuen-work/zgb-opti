"""Download XAUUSD M1 data from MT5 broker — fetches as far back as possible."""
...
def main():
    ...
    csv_path     = OUTPUT_DIR / "xauusd_m1_full.csv"
    parquet_path = OUTPUT_DIR / "xauusd_m1_full.parquet"
