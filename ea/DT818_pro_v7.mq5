...
//|         + SMA(8)x(21) cross-exit on post-HTP runners (NEW v7)     |
//|                                                                   |
...
int OnInit()
{
   ...
   PrintFormat("[DT818_pro_v7] Init. Parents S1=%d S2=%d S3=%d S4=%d S5=%d S6=%d  "
   ...
   PrintFormat("[DT818_pro_v7] Parents: "
   ...
   PrintFormat("[DT818_pro_v7] STOP-ext Hedges: "
